(self["webpackChunk"] = self["webpackChunk"] || []).push([["vendors-node_modules_air-datepicker_dist_js_datepicker_js-node_modules_air-datepicker_src_js_-2ff550"],{
...
;(function (window, $, undefined) { ;(function () {
    var VERSION = '2.2.3',
        ...
        baseTemplate = '' +
            ...
            // '<div class="datepicker__input_guests">' +
            // '<buttons class="datepicker--button" dada-action="clear">очистить</buttons>' +
            // '<buttons class="dropdown__apply">применить</buttons>' +
            // '</div>' +
            '</div>',
        defaults = {
            classes: '',
            ...
            prevHtml: `<svg width="17" height="18" viewBox="-2 -2 21 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M16.1755 8.01562V9.98438H3.98801L9.56613 15.6094L8.15988 17.0156L0.144258 9L8.15988 0.984375L9.56613 2.39062L3.98801 8.01562H16.1755Z"/>
                    </svg>`,
            nextHtml: `<svg width="17" height="18" viewBox="-2 -2 21 22" fill="none" xmlns="http://www.w3.org/2000/svg">
...
//# sourceMappingURL=vendors-node_modules_air-datepicker_dist_js_datepicker_js-node_modules_air-datepicker_src_js_-2ff550.js.map